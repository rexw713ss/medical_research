...
FILES = [
    ...
    "eicu_frozen_baseline_validation.py",
    ...
    "full_data_window_utils.py",
    "formal_data_scope_audit.py",
    ...
    "outputs/posthoc_explainability_comparison_6h/formal_cohort_audit.json",
    "outputs/posthoc_explainability_comparison_6h/explanation_quality_comparison.csv",
    "outputs/posthoc_explainability_comparison_6h/unified_explanation_complexity.csv",
    "outputs/posthoc_explainability_comparison_6h/unified_explanation_complexity_audit.json",
    "outputs/eicu_frozen_baseline_validation_6h/external_baseline_metrics.csv",
    "outputs/eicu_frozen_baseline_validation_6h/paired_vs_equal_sample_kg_tfnn.csv",
    "outputs/eicu_frozen_baseline_validation_6h/formal_cohort_and_freeze_audit.json",
    "outputs/eicu_frozen_baseline_validation_6h/mimic_transfer_parameters.json",
    "outputs/eicu_frozen_baseline_validation_6h/source_prediction_reproduction.json",
    "outputs/clinical_consistency_regularization_6h/analysis_config.json",
    "outputs/clinical_consistency_regularization_6h/formal_cohort_audit.json",
    "outputs/clinical_consistency_regularization_6h/consistency_metrics_by_seed.csv",
    "outputs/formal_data_scope_audit_6h/formal_data_scope_audit.json",
    "outputs/formal_data_scope_audit_6h/formal_data_scope_audit.md",
    ...
    "paper/TSP_template.tex",
    "paper/Supplementary_Material.tex",
    "docs/manuscript_experiment_audit.md",
