...
- [教授建議與投稿宣稱完成度稽核](manuscript_experiment_audit.md)
- [主文 TeX](../paper/TSP_template.tex) / [編譯 PDF](../paper/TSP_template.pdf)
- [Supplementary TeX](../paper/Supplementary_Material.tex) / [編譯 PDF](../paper/Supplementary_Material.pdf)
- [2026-07-14 一致性修訂前原稿備份](../paper/backups/20260714_151000_before_consistency_alignment/)
- [2026-07-14 trade-off 收斂前原稿備份](../paper/backups/20260714_210917_before_tradeoff_reframing/)
...
- [正式實驗資料範圍稽核](../outputs/formal_data_scope_audit_6h/formal_data_scope_audit.md)
...
- [Full-data post-hoc XAI structural benchmark](../outputs/posthoc_explainability_comparison_6h/explanation_quality_report.md)
- [Unified cross-model explanation complexity](../outputs/posthoc_explainability_comparison_6h/unified_explanation_complexity_report.md)
- [Frozen equal-sample baseline external validation on eICU](../outputs/eicu_frozen_baseline_validation_6h/eicu_frozen_baseline_validation_report.md)
- [Full-test-cohort clinical consistency behavioral audit](../outputs/clinical_consistency_regularization_6h/clinical_consistency_report.md)
- [SOFA documentation-bias sensitivity](../outputs/sofa_documentation_bias_6h/sofa_documentation_bias_report.md)
